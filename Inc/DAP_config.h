...
#else
#include "stm32l412.h"                             // Debug Unit Cortex-M Processor Header File
...
__STATIC_INLINE void PORT_SWD_SETUP (void) {
    ...
    /*Reset all 3 pins.*/
    GPIO_CLEAR_DAP_nRESET_MODER();
    GPIO_CLEAR_DAP_nRESET_OSPEEDR();
    GPIO_CLEAR_DAP_nRESET_OTYPER();
    GPIO_CLEAR_DAP_nRESET_PUPDR();
    GPIO_CLEAR_DAP_nRESET_AFR();

    GPIO_CLEAR_DAP_SWCLK_MODER();
    GPIO_CLEAR_DAP_SWCLK_OSPEEDR();
    GPIO_CLEAR_DAP_SWCLK_OTYPER();
    GPIO_CLEAR_DAP_SWCLK_PUPDR();
    GPIO_CLEAR_DAP_SWCLK_AFR();

    GPIO_CLEAR_DAP_SWDIO_MODER();
    GPIO_CLEAR_DAP_SWDIO_OSPEEDR();
    GPIO_CLEAR_DAP_SWDIO_OTYPER();
    GPIO_CLEAR_DAP_SWDIO_PUPDR();
    GPIO_CLEAR_DAP_SWDIO_AFR();


    /*Initialize all 3 pins*/
    GPIO_SET_DAP_nRESET_MODER();
    GPIO_SET_DAP_nRESET_OSPEEDR();
    GPIO_SET_DAP_nRESET_OTYPER();

    GPIO_SET_DAP_SWCLK_MODER();
    GPIO_SET_DAP_SWCLK_OSPEEDR();

    GPIO_SET_DAP_SWDIO_MODER();
    GPIO_SET_DAP_SWDIO_OSPEEDR();
...
__STATIC_FORCEINLINE void     PIN_SWDIO_OUT     (uint32_t bit) {
    !(bit & 0x1U) ? GPIO_CLEAR_DAP_SWDIO() : GPIO_SET_DAP_SWDIO();
}
...
__STATIC_FORCEINLINE void     PIN_nRESET_OUT (uint32_t bit) {
    !(bit & 0x1U) ? GPIO_CLEAR_DAP_nRESET() : GPIO_SET_DAP_nRESET();
}
...
__STATIC_INLINE void DAP_SETUP (void) {
    ...
    /*Enable clocks.*/
    RCC_SWDIO_CLK_ENABLE();
    RCC_SWCLK_CLK_ENABLE();
    RCC_nRESET_CLK_ENABLE();
